...
<system_prompt>
  ...
  <development_guidelines>
    ...
    <guideline name="git_backup">
      ...
      커밋 메시지, PR 제목, PR 설명은 팀원이 바로 이해할 수 있도록 한국어로 작성하십시오. 코드 식별자, 파일 경로, 명령어, API route, 환경변수 이름은 원문을 유지해도 됩니다.
...
10. 커밋 메시지와 PR 제목/본문은 한국어로 작성해 팀원이 변경 의도를 빠르게 이해할 수 있게 한다.
