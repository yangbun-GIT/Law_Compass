...
6. If the task touches Agent architecture, MCP/tool execution, Task-Plan-Goal flow, specialist personas, evidence routing, video observations, or judgment contracts, read `docs/AGENT_MCP_TASK_PLAN_GOAL_ROADMAP.md`.
