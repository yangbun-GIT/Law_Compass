...
class AnalysisOutput(BaseModel):
    ...
    agent_goal_result: dict[str, Any] = Field(default_factory=dict)
    agent_replan: dict[str, Any] = Field(default_factory=dict)
    specialist_agent_results: dict[str, Any] = Field(default_factory=dict)
    specialist_prompt_registry: dict[str, Any] = Field(default_factory=dict)
    ...
    reflection_loop: dict[str, Any] = Field(default_factory=dict)
    input_requirements: dict[str, Any] = Field(default_factory=dict)
    guided_questionnaire: dict[str, Any] = Field(default_factory=dict)
    analysis_mode_contract: dict[str, Any] = Field(default_factory=dict)
    knia_adjustment_agent: dict[str, Any] = Field(default_factory=dict)
