...
import {
  ...
  asArray,
  buildKniaChartFallbackSearchClause,
  buildKniaRankingPartyClause,
  buildKniaRankingSearchClause,
  cleanKniaPublicText,
  dedupeKniaRankingItems,
  finiteNumber,
  normalizeAdjustmentExplanations,
  normalizeAdjustmentFactors,
  normalizeCaseReferences,
  normalizeKniaRankingQuery,
  normalizeKniaRankingRow,
  normalizeRelatedLaws,
  parameter,
  publicKniaThumbnail,
  safeText,
  summarizeRankingDetailStatus,
} from "../lib/knia-route-presenter.js";
