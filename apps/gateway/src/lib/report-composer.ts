...
function videoQuestionPriority(field: string) {
  const order: AnyRecord = {
    ...
    sudden_brake: 140,
    lane_change_actor: 150,
    opponent_signal_violation: 160,
    user_signal: 170,
    opponent_signal: 180,
    turn_signal: 190,
...
function missingInfoQuestionPriority(field: string) {
  const order: AnyRecord = {
    ...
    opponent_behavior: 7,
    centerline_crossed: 8,
    centerline_cross_reason: 9,
    road_obstruction: 10,
    illegal_parking_obstruction: 11,
    opposing_vehicle_present: 12,
    opposing_vehicle_did_not_stop: 13,
    secondary_collision: 14,
    sudden_brake: 15,
    lane_change_actor: 16,
    opponent_signal_violation: 17,
    user_signal: 18,
    opponent_signal: 19,
    bicycle_location: 20,
    bicycle_direction: 21,
    crosswalk_nearby: 22,
    pedestrian_visible: 23,
    pedestrian_signal: 24,
    school_zone: 25,
    victim_is_child: 26,
    injury: 27,
    damage_level: 28,
